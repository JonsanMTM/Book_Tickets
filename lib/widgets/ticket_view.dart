                    ...
                    children: [
                      Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Text(
                            "${ticket['date']}",
                            style: isColor==null?  Style.headLineStyle3
                                .copyWith(color:Colors.white):Style.headLineStyle3,
                          ),
                          Gap(AppLayout.getHeight(5)),
                          Text(
                            "Date",textAlign: TextAlign.start,
                            style: isColor==null?  Style.headLineStyle4
                                .copyWith(color:Colors.white):Style.headLineStyle4,
                          ),
                        ],
                      ),
                      Column(
